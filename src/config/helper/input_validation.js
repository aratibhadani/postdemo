...
function postArticalInputValidation(data) {
    const schema = Joi.object({
        ...
        content: Joi.string().required().messages({
            "string.empty": "content must be required!!",
        }),
    }).options({ abortEarly: true });
    return schema.validate(data)
}
...
module.exports = { createUserValidation, loginValidation, postArticalInputValidation, changePasswordValidation,changeForgetPasswordValidation ,forgetPasswordValidation,editUserValidation}
